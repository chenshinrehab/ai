      ...
      <main className="max-w-4xl mx-auto px-6 pt-10 md:pt-16 relative">
        <article className="relative z-10">
          ...
          {/* ==========================================
              標題區塊：我的理念
             ========================================== */}
          <MotionWrapper type="fadeInUp" className="bg-white rounded-[2.5rem] p-10 md:p-16 shadow-xl shadow-blue-900/5 border border-slate-100 text-center relative overflow-hidden">
...
{/* 🟢 修改點 1：將 flex 改為 flex-col (手機上下排) md:flex-row (電腦左右排) */}
{/* 🟢 修改點 2：items-center (手機圖示置中) md:items-start (電腦圖示靠上) */}
<div className="flex flex-col md:flex-row items-center md:items-start gap-4 md:gap-5">
  
  {/* 🟢 修改點 3：手機版讓圖示稍微縮小，避免佔空間 */}
  ...
  {/* 🟢 修改點 4：移除 text-center，改用 md:text-left 確保電腦版正常，手機版則能填滿空間 */}
...
{/* 🟢 手機版改為垂直排列 (flex-col)，電腦版恢復左右排列 (md:flex-row) */}
<div className="flex flex-col md:flex-row items-center md:items-start gap-4 md:gap-5">
  ...
  <div className="w-full">
    ...
    {/* 🟢 文字改為 w-full 並在手機版使用 text-justify (左右貼齊) */}
    <p className="text-slate-600 font-normal leading-relaxed text-[15px] md:text-[16px] text-justify md:text-left w-full">
...
<div className="flex flex-col md:flex-row items-center md:items-start gap-4 md:gap-5">
  ...
  <div className="w-full">
    ...
    {/* 🟢 內文：w-full 確保填滿，手機版使用 text-justify 讓兩端對齊 */}
    <p className="text-slate-600 font-normal leading-relaxed text-[15px] md:text-[16px] text-justify md:text-left w-full">
